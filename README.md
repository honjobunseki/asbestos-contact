...
1. **市区町村検索**
   ...
   - **都道府県全域検索** ⭐NEW
     - 検索ボックスに「埼玉県」「北海道」などと入力すると「都道府県全域」候補を表示
     - プルダウンで都道府県を選択すると、市区町村の最初に「○○県全域」オプションが表示
     - 都道府県全域を選択すると、その都道府県の総合窓口を検索
...
1. **市区町村を選択**
   ...
   - 方法3: **都道府県全域で検索** ⭐NEW
     - 検索ボックスに「埼玉県」「北海道」と入力して「○○県全域」を選択
     - プルダウンで都道府県を選択し、市区町村で「○○県全域」を選択
