...
// 検索用のフラットなリスト（インクリメンタルサーチ用）
export const citiesFlatList: Array<{prefecture: string, city: string, fullName: string}> = [];
...
// 都道府県リスト
export const prefectures = Object.keys(citiesData);
